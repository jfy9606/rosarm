...
if("TRUE" STREQUAL "TRUE")
  set(arm_trajectory_SOURCE_PREFIX /home/jfy/arm/catkin/src/arm_trajectory)
  set(arm_trajectory_DEVEL_PREFIX /home/jfy/arm/catkin/devel/.private/arm_trajectory)
  ...
  set(arm_trajectory_INSTALL_PREFIX /home/jfy/arm/catkin/install)
...
if(NOT "/home/jfy/arm/catkin/devel/.private/arm_trajectory/include " STREQUAL " ")
  set(arm_trajectory_INCLUDE_DIRS "")
  set(_include_dirs "/home/jfy/arm/catkin/devel/.private/arm_trajectory/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'arm_trajectory' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'arm_trajectory' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jfy/arm/catkin/src/arm_trajectory/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT arm_trajectory_NUM_DUMMY_TARGETS)
      set(arm_trajectory_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::arm_trajectory::wrapped-linker-option${arm_trajectory_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR arm_trajectory_NUM_DUMMY_TARGETS "${arm_trajectory_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::arm_trajectory::wrapped-linker-option${arm_trajectory_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND arm_trajectory_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND arm_trajectory_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jfy/arm/catkin/devel/.private/arm_trajectory/lib;/home/jfy/arm/catkin/devel/lib;/opt/ros/noetic/lib)
...
set(arm_trajectory_EXPORTED_TARGETS "arm_trajectory_generate_messages_cpp;arm_trajectory_generate_messages_eus;arm_trajectory_generate_messages_lisp;arm_trajectory_generate_messages_nodejs;arm_trajectory_generate_messages_py")
...
set(depends "roscpp;rospy;std_msgs;geometry_msgs;moveit_msgs;moveit_core;moveit_ros_planning_interface;message_runtime")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${arm_trajectory_dep}_FOUND)
      find_package(${arm_trajectory_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${arm_trajectory_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(arm_trajectory_EXPORTED_TARGETS ${${arm_trajectory_dep}_EXPORTED_TARGETS})
endforeach()
