#ifndef MOTOR_MOTOR_CONTROL_H
#define MOTOR_MOTOR_CONTROL_H
...
public:
    // 电机参数的限制范围
    const int16_t MAX_VELOCITY = 1000;
    const int16_t MIN_VELOCITY = -1000;
    const int32_t MAX_POSITION = 10000;
    const int32_t MIN_POSITION = -10000;
