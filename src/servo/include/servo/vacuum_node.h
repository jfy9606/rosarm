#ifndef SERVO_VACUUM_NODE_H
#define SERVO_VACUUM_NODE_H

#include <ros/ros.h>
#include <std_msgs/Bool.h>
#include <std_msgs/Int32.h>
#include <servo/VacuumCmd.h>
#include <servo/vacuum_control.h>
#include <string>
...
public:
     ...
     * @return 服务调用是否成功
     */
    bool vacuumServiceCallback(servo::VacuumCmd::Request& req, 
